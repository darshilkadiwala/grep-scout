    ...
    vscode.window
      .showInformationMessage(
        "FileScout has been rebranded to GrepScout!",
        {
          modal: true,
          detail:
            "We have rebranded our extension and released it as GrepScout. The new extension has been automatically installed for you. You can safely uninstall the old FileScout extension. Click on 'View in Marketplace' below to view it. Visit our repository: https://github.com/darshilkadiwala/grep-scout",
        },
        "View in Marketplace",
        "Remind me later",
      )
